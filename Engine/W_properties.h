...
private:
	...
	void DrawMeshBody(CMesh* mesh);							// Subfunction of DrawComponentHeader. Draws the Geometry information of the mesh in the GameObject into the window (Number of meshes, textures, triangles, faces...)
