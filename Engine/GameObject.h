...
private:
	...
	const int	UUID;																			// Unique identifier of this GameObject instance
...
public:
	...
	GameObject(const std::string& _name, const int _UUID);										// Constructor (name, UUID as param)
	...
	CTransform*			GetTransform() const		{ return transform; }								// Returns the local Transform Component of this GameObject, if there is one. If not, returns nullptr. NOTE: It contains the local Model Matrix of the object
	...
	// Returns a component of this GameObject by UUID
	...
	// Get a component of type T, or null if it does not exist on this GameObject
	template<typename T>
	...
	// Get a vector of component of type T, empty if it does not exist on this GameObject
	template<typename T>
